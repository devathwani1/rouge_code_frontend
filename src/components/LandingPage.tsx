...
import landscapeBg from "../assets/landscape2-bg.jpg";
...
export default function LandingPage({
  ...
  }, [handleResize, colorVector, density, depthFade, direction, farPlane, flakeSize, gamma, minFlakeSize, pixelResolution, speed, variantValue, brightness]);
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: "-20px", // Expand slightly to hide blurred edges
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(circle at center, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 1.9) 150%, rgba(0, 0, 0, 0.9) 100%)",
          zIndex: 1,
        }}
      />
      <div
      ...
      >
        ...
        />
        <div style={{ width: "100%", height: "400px", maxWidth: "1000px", pointerEvents: "auto" }}>
          ...
          >
            ...
            >
              "Where Consistent Practice Leads to Mastery.<br />
              Designed to help developers grow through daily problem-solving."
            </span>
            ...
            <button
              style={{
                ...
                boxShadow: "0 0 20px rgba(0, 210, 255, 0.2), inset 0 0 10px rgba(255, 255, 255, 0.1)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                overflow: "hidden",
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "rgba(100, 230, 255, 0.15)";
                e.currentTarget.style.boxShadow = "0 0 20px rgba(0, 210, 255, 0.2), inset 0 0 10px rgba(255, 255, 255, 0.1)";
